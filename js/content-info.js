    ...
    'Experience': [
        {
            ...
            'description': 'I interned at Pinterest in Summer 2016 as a Software Engineer. As an iOS Engineer on the Growth Engineering team, I implemened a new UI Component, called the Action Prompt, which is a window that pops up on the user\'s screen to educate them about core features of the app, such as repinning pins to boards, or creating new boards. The action prompt also prompts users to take actions related to the education and allows them to do so directly. I also wrote backend logic for iOS features I worked on to handle the unique requirements of different action prompts, such as fetching the user\'s browsing history or engagement level in Pinterest. Another feature I worked on was Screenshot Repins, which automatically repins pins that a user screenshots to a special board called "Screenshots". For all of these features, I ran A/B experiments to test their effectiveness on core metrics.',
            'link': 'https://www.pinterest.com/',
            'pictures': 'pinterest-1.png',
            'class': 'pinterest',
            'round': true
        },
        {
            ...
            'description': 'As an iOS Intern for Vurb in Summer 2015, I worked on the app\'s Group Chat feature, an extension of the existing one-to-one messaging feature. I was mainly responsible for the main chats list page, the edit group chat page, and the create group chat page. In the main list page, I took the existing UI for the one-to-one page and updated it to account for groups. In the edit group chat page, I implemented features such as changing the group name and adding/deleting users from the chat. In the create group chat page, I extended existing functionality for selecting Vurb friends or contacts and allowing the user to select multiple people, choose a group name, and begin chatting. All of this also involved allowing the app to respond to events in real time as well. In addition to the features, I wrote Automation Tests with KIF-Kiwi and some Xcode Unit Tests to ensure functionality. ',
        ...
        },
        {
            'title': 'Artsicle',
            'image': 'artsicle.png',
            'slogan': 'Find amazing art, direct from the artist\'s studio',
            'description': 'I interned at Artsicle in New York City in Spring 2014. I worked in various parts of the app as a Full-Stack Engineer. I implemented the Help Center from the ground up, which is a resource hub for users, specifically artists to refer to if they have trouble using the app. This involved building the Ruby on Rails resources, bringing the design to life, and plugging it into the existing admin portal so admins from Artsicle could easily create and edit the content. The second major feature I worked on was a design makeover for the messaging feature, which involved creating a split-view experience for users to easily navigate and view their messages.',
            'link': 'https://www.artsicle.com/',
            'pictures': 'artsicle-1.png',
            'class': 'artsicle'
        },
        {
            'title': 'PureHistory',
    ...
    'Projects': [
        {
            ...
            'description': 'SAGE Mentorship is a nonprofit at UC Berkeley that connects student mentors to youth in local communities. Mentors would be paired with elementary school students, and engage in activities such as playing sports, eating, or simply giving the younger ones advice. The SAGE Mentorship app (personally worked on the iOS app) is a solution to the problem the organization was having of recording and maintaining the hours that the mentors worked. By moving the pen and paper system to a digital system, the app allows mentors to easily check in their mentoring sessions as the app verifies their location. It also provides and easy and clean way for mentors to track their progress and hours throughout the school semester. Admins can also track mentors\' progress and make sure they are consistent with their sessions. The app is currently out on the Apple Store, as well as the Google Play Store.',
            'link': 'https://itunes.apple.com/us/app/sage-mentorship/id1082583314?mt=8',
            'pictures': 'sage-1.png',
            'class': 'sage'
        },
        {
